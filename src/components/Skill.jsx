export default function Skill() {
    return (
        <div className="hero bg-base-300 min-h-screen" id="skills">
            <div className="tools text-center">
                <div className="max-w-md">
                    ...
                    <div className="hero-content flex-col lg:flex-row">
                        ...
                        {/* C++ */}
                        <div className="animate-[bounce_5s_ease-in-out_infinite] tools bg-base-100 min-w-50 h-40 ">
                        ...
                        {/* HTML */}
                        <div className="animate-[bounce_4s_ease-in-out_infinite] card bg-base-100 min-w-50 h-40 shadow-sm">
                            <div className="card-body items-center text-center">
                        ...
                        {/* CSS */}
                        <div className="animate-[bounce_3s_ease-in-out_infinite] card bg-base-100 min-w-50 h-40 shadow-sm">
                            <div className="card-body items-center text-center">
                                <span>
                        ...
                        {/* PHP */}
                        <div className="animate-[bounce_5s_ease-in-out_infinite] card bg-base-100 min-w-50 h-40 shadow-sm">
                            <div className="card-body items-center text-center">
                                <span>
